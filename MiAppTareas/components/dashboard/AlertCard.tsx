...
const styles = StyleSheet.create({
  ...
  description: { fontSize: 14, color: colors.text.secondary, lineHeight: 20, marginBottom: 4 },
  date: { fontSize: 12, color: colors.text.muted, fontWeight: '500' },
  arrowContainer: { paddingLeft: 4 },
  arrow: { fontSize: 28, color: colors.text.muted, fontWeight: '300' },
});
